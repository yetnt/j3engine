 ...
 * {@link Command#run(com.j3d.engine.interact.cmd.Invoker, SafeJLabel, String, Object[], java.util.ArrayList)} is required to call {@link CommandsManager#setAsCurrent(SemiStatefulCommand)}
