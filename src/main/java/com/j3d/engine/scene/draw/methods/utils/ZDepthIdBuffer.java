...
public class ZDepthIdBuffer {
    ...
    public void line(GLine line) {
        Point p1 = line.getA().getPivot().toPoint(StaticRefs.getCamera()).toScreen().toSwingPoint();
        Point p2 = line.getB().getPivot().toPoint(StaticRefs.getCamera()).toScreen().toSwingPoint();
    ...
    public void point(GPoint pt) {
        Point screenPt = pt.getPivot().toPoint(StaticRefs.getCamera()).toScreen().toSwingPoint();
        int x = screenPt.x;
        int y = screenPt.y;
    ...
    public void tri(GTri triangle) {
        Point p1 = triangle.getLegA().getA().getPivot().toPoint(StaticRefs.getCamera()).toScreen().toSwingPoint();
        Point p2 = triangle.getLegB().getA().getPivot().toPoint(StaticRefs.getCamera()).toScreen().toSwingPoint();
        Point p3 = triangle.getLegC().getA().getPivot().toPoint(StaticRefs.getCamera()).toScreen().toSwingPoint();
