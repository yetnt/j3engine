...
/**
 * A Thing, or more commonly in engine lingo, a mesh, is an {@link SceneObjectList}
 ...
 * @see Action
 */
public class Thing implements SceneObjectList {
    ...
    /**
     * Governed by {@link SceneObjectList}, whether this Thing is hidden or not.
     */
    private boolean hidden = false;
    /**
     * Governed by {@link SceneObjectList}, whether this Thing is for deletion or not.
     */
    private boolean forDeletion = false;

    /**
     * Required by {@link SceneObjectList}, The Tree Node Identity object defining this Thing
     * within the Tree GUI.
     */
    private TreeNodeIdentity<Thing> treeNodeIdentity;
    /**
     * Required by {@link SceneObjectList}, The actual tree node reference
