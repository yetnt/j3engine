        ...
        addCompAt(
                ...
                new JLabel(
                        new InlineHTML(
                                ...
                                .addLn(InlineHTML.LINE_BREAK)
                                .add(new InlineHTML("<vector3>", true).bold())
                                .add(" - A position or direction. This is in the form of (number, number, number). like ")
                                .add(new InlineHTML("(10, 3, -24)").bold().italic())
                                .addLn(InlineHTML.LINE_BREAK)
                                .add(new InlineHTML("<string>", true).bold())
                                .add(" - simply input that is between a pair of double quotes. like ")
                                .add(new InlineHTML("\"my string\"").bold().italic())
                                .addLn(InlineHTML.LINE_BREAK)
                                .add(new InlineHTML("<number>", true).bold())
                                .add(" - simply a number. (if it needs a whole number, it will say integer) like ")
                                .add(new InlineHTML("10").bold().italic())
                                .addLn(InlineHTML.LINE_BREAK)
                                .add(new InlineHTML("<boolean>", true).bold())
                                .add(" - either true or false. like ")
                                .add(new InlineHTML("true").bold().italic())
                                .addLn(InlineHTML.LINE_BREAK)
                                .add(new InlineHTML("<point>/<line>/<tri>/<curve>/<thing>", true).bold())
                                ...
                                .add(new InlineHTML("a7e58b1c-2d3f-4a5b-6c7d-8e9f0a1b2c3d").bold().italic())
