 ...
 * @author ACER
 */
public class Spinner extends javax.swing.JDialog {

    /**
     * Creates new form Thr
     */
    public Spinner(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Spinner dialog = new Spinner(new javax.swing.JFrame(), true);
